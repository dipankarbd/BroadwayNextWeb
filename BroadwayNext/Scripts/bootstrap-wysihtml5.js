!function($, wysi) {
    ...
    var tpl = {
        ...
        "font-size": function (locale) {
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='btn btn-primary' data-toggle='dropdown' href='#'>" +
                "<span class='current-font'>Size</span>&nbsp;<b class='caret'></b>" +
              "</a>" +
              "<ul class='dropdown-menu'>" +
                "<li><a  data-wysihtml5-command='fontSize' data-wysihtml5-command-value='x-small'>x-small</a></li>" +
                "<li><a  data-wysihtml5-command='fontSize' data-wysihtml5-command-value='small'>small</a></li>" +
                "<li><a  data-wysihtml5-command='fontSize' data-wysihtml5-command-value='medium'>medium</a></li>" +
                "<li><a  data-wysihtml5-command='fontSize' data-wysihtml5-command-value='large'>large</a></li>" +
                "<li><a  data-wysihtml5-command='fontSize' data-wysihtml5-command-value='x-large'>x-large</a></li>" +
              "</ul>" +
              "</div>" +
            "</li>";
        },
        ...
        "emphasis": function(locale) {
            return "<li>" +
              ...
              //  "<li><a  data-wysihtml5-command='fontSize' data-wysihtml5-command-value='x-large'>x-large</a></li>" +
              //"</ul>" +
                "<a class='btn btn btn-info ' data-wysihtml5-command='bold' title='CTRL+B'>Bold</a>" +
                "<a class='btn btn-warning' data-wysihtml5-command='italic' title='CTRL+I'>Italic</a>" +
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["./Content/css/wysiwyg-color.css"], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };
